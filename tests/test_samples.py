...
class TestSamples:
    ...
    def test_sample1_opt_help(self):
        """sample1 --help option"""
        pattern1(SAMPLE1_CMD, "help", [f"Usage: {SAMPLE1}"], [])

    def test_sample1_opt_version(self):
        """sample1 --version option"""
        pattern1(SAMPLE1_CMD, "version", [f"{SAMPLE1} "], [])

    def test_sample1_opt_debug(self):
        """sample1 --debug option"""
        pattern1(SAMPLE1_CMD, "debug", ["[DEBUG] "], [])
    ...
    def test_sample2_opt_help(self):
        """sample2 --help option"""
        pattern1(
            SAMPLE2_CMD, "help", [f"Usage: {SAMPLE2}", "Options:"], []
        )

    def test_sample2_opt_version(self):
        """sample2 --version option"""
        pattern1(SAMPLE2_CMD, "version", [f"{SAMPLE2} "], [])

    def test_sample2_opt_debug(self):
        """sample2 --debug option"""
        pattern1(
